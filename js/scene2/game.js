...
class HUD extends Phaser.Scene {
    ...
    preload(){
        this.load.image('hud1', '/Animal-Expirement/resources/hud_images/scene2hud/hud_1.png')
        this.load.image('hud2', '/Animal-Expirement/resources/hud_images/scene2hud/hud_2.png')
    }
